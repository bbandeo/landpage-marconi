                    ...
                    <CardContent className="card-premium">
                      <div className="flex items-start space-x-premium-md">
                        ...
                        <div>
                          ...
                          <p className="body-md text-premium-secondary">Email: contacto@marconi.com</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
      ...
      <section className="section-premium bg-premium-main">
        <div className="container-premium">
          ...
          >
            <Card>
              <CardContent className="card-premium">
                <div className="aspect-video bg-support-gray/10 rounded-2xl overflow-hidden relative">
                  {/* Overlay para oscurecer el mapa */}
                  ...
                  <div className="absolute top-1/2 left-4 md:left-8 transform -translate-y-1/2 z-20 bg-[#1e293b] p-6 rounded shadow-2xl border-l-4 border-orange-500 max-w-xs hidden md:block">
                    ...
                    <a href="https://maps.google.com/?q=Jorge+Newbery+1562,+Reconquista,+Santa+Fe" target="_blank" rel="noopener noreferrer" className="text-orange-500 text-sm hover:underline flex items-center gap-1">
                      Cómo llegar &rarr;
                    </a>
                  </div>
                </div>
