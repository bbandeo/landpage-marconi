  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const submitData = {
        ...
        images: imagePreview, // Usar las URLs de las imágenes subidas
      }
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="3"
                    disabled={formData.property_type === "terreno" || formData.property_type === "local"}
                  />
                  {errors.bedrooms && <p className="text-red-500 text-xs mt-1">{errors.bedrooms}</p>}
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    Baños {(formData.property_type === "casa" || formData.property_type === "departamento") && "*"}
                  </label>
                  <input
                    type="number"
