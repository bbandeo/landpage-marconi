...
export function House3D() {
  useEffect(() => {
    // Lógica de rotación del modelo (adaptada de script.js)
    const h = document.querySelector("#h") as HTMLElement | null;
    if (!h) return;
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center house-container">
      {/* Este es el árbol HTML original del modelo completo */}
