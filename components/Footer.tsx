        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              ...
              <a href="https://www.instagram.com/marconinegociosinmobiliarios" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-500 transition"><Instagram size={20} /></a>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li><Link href="/propiedades" className="hover:text-orange-500 transition">Propiedades en Venta</Link></li>
              <li><Link href="/propiedades" className="hover:text-orange-500 transition">Propiedades en Alquiler</Link></li>
              <li><Link href="/agentes" className="hover:text-orange-500 transition">Nuestros Agentes</Link></li>
              <li><Link href="#" className="hover:text-orange-500 transition">Oportunidades de Inversión</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li><Link href="#" className="hover:text-orange-500 transition">Defensa del Consumidor</Link></li>
            </ul>
          </div>
